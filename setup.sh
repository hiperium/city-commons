...
function setEnvironmentVariables() {
    ...
    export DLQ_NAME="cities-event-bus-dlq"
    export EVENT_BUS_NAME="cities-event-bus"
}
...
menu() {
    ...
    *******************************************
    ...
    [Hh])
        ...
        ;;
    1)
        "$WORKING_DIR"/utils/scripts/1_build-docker-files.sh
        clear
        echo ""
        echo "DONE!"
        menu
    ...
    2)
        printRemainingSessionTime
        "$WORKING_DIR"/utils/scripts/2_create-backend.sh
        clear
        echo ""
        echo "DONE!"
        menu
    ...
    3)
        printRemainingSessionTime
        "$WORKING_DIR"/utils/scripts/3_delete-backend.sh
        clear
        echo ""
        echo "DONE!"
        menu
